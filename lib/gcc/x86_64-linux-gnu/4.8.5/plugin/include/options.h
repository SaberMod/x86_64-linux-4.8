...
enum opt_code
{
  ...
  OPT_m128bit_long_double = 1039,            /* -m128bit-long-double */
  OPT_m32 = 1040,                            /* -m32 */
  OPT_m3dnow = 1041,                         /* -m3dnow */
  OPT_m3dnowa = 1042,                        /* -m3dnowa */
  OPT_m64 = 1043,                            /* -m64 */
  OPT_m80387 = 1044,                         /* -m80387 */
  OPT_m8bit_idiv = 1045,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1046,             /* -m96bit-long-double */
  OPT_mabi_ = 1047,                          /* -mabi= */
  OPT_mabm = 1048,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1049,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1050,                 /* -maddress-mode= */
  OPT_madx = 1051,                           /* -madx */
  OPT_maes = 1052,                           /* -maes */
  OPT_malign_double = 1053,                  /* -malign-double */
  OPT_malign_functions_ = 1054,              /* -malign-functions= */
  OPT_malign_jumps_ = 1055,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1056,                  /* -malign-loops= */
  OPT_malign_stringops = 1057,               /* -malign-stringops */
  OPT_mandroid = 1058,                       /* -mandroid */
  ...
  OPT_mbionic = 1065,                        /* -mbionic */
  OPT_mbmi = 1066,                           /* -mbmi */
  OPT_mbmi2 = 1067,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1068,                  /* -mbranch-cost= */
  OPT_mcld = 1069,                           /* -mcld */
  ...
  OPT_mf16c = 1075,                          /* -mf16c */
  OPT_mfancy_math_387 = 1076,                /* -mfancy-math-387 */
  OPT_mfentry = 1077,                        /* -mfentry */
  OPT_mfma = 1078,                           /* -mfma */
  OPT_mfma4 = 1079,                          /* -mfma4 */
  OPT_mforce_drap = 1080,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1081,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1082,                       /* -mfpmath= */
  OPT_mfsgsbase = 1083,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1084, */              /* -mfused-madd */
  OPT_mfxsr = 1085,                          /* -mfxsr */
  ...
  OPT_momit_leaf_frame_pointer = 1107,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1108,                          /* -mpc32 */
  OPT_mpc64 = 1109,                          /* -mpc64 */
  OPT_mpc80 = 1110,                          /* -mpc80 */
  OPT_mpclmul = 1111,                        /* -mpclmul */
  OPT_mpopcnt = 1112,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1113,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1114,     /* -mpreferred-stack-boundary= */
  OPT_mprfchw = 1115,                        /* -mprfchw */
  OPT_mpush_args = 1116,                     /* -mpush-args */
  OPT_mrdrnd = 1117,                         /* -mrdrnd */
  OPT_mrdseed = 1118,                        /* -mrdseed */
  OPT_mrecip = 1119,                         /* -mrecip */
  OPT_mrecip_ = 1120,                        /* -mrecip= */
  OPT_mred_zone = 1121,                      /* -mred-zone */
  OPT_mregparm_ = 1122,                      /* -mregparm= */
  OPT_mrtd = 1123,                           /* -mrtd */
  OPT_mrtm = 1124,                           /* -mrtm */
  OPT_msahf = 1125,                          /* -msahf */
  OPT_msoft_float = 1126,                    /* -msoft-float */
  OPT_msse = 1127,                           /* -msse */
  OPT_msse2 = 1128,                          /* -msse2 */
  OPT_msse2avx = 1129,                       /* -msse2avx */
  OPT_msse3 = 1130,                          /* -msse3 */
  OPT_msse4 = 1131,                          /* -msse4 */
  OPT_msse4_1 = 1132,                        /* -msse4.1 */
  OPT_msse4_2 = 1133,                        /* -msse4.2 */
  OPT_msse4a = 1134,                         /* -msse4a */
  /* OPT_msse5 = 1135, */                    /* -msse5 */
  OPT_msseregparm = 1136,                    /* -msseregparm */
  OPT_mssse3 = 1137,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1138,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1139,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1140,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1141,            /* -mstringop-strategy= */
  OPT_mtbm = 1142,                           /* -mtbm */
  OPT_mtls_dialect_ = 1143,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1144,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1145,                         /* -mtune= */
  OPT_muclibc = 1146,                        /* -muclibc */
  OPT_mveclibabi_ = 1147,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1148,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1149,                    /* -mvzeroupper */
  OPT_mx32 = 1150,                           /* -mx32 */
  OPT_mxop = 1151,                           /* -mxop */
  OPT_mxsave = 1152,                         /* -mxsave */
  OPT_mxsaveopt = 1153,                      /* -mxsaveopt */
  OPT_n = 1154,                              /* -n */
  ...
  OPT_static_libstdc__ = 1203,               /* -static-libstdc++ */
  OPT_static_libtsan = 1204,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1205, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1206, */                /* -std=c++0x */
  OPT_std_c__11 = 1207,                      /* -std=c++11 */
  OPT_std_c__1y = 1208,                      /* -std=c++1y */
  OPT_std_c__98 = 1209,                      /* -std=c++98 */
  OPT_std_c11 = 1210,                        /* -std=c11 */
  /* OPT_std_c1x = 1211, */                  /* -std=c1x */
  /* OPT_std_c89 = 1212, */                  /* -std=c89 */
  OPT_std_c90 = 1213,                        /* -std=c90 */
  OPT_std_c99 = 1214,                        /* -std=c99 */
  /* OPT_std_c9x = 1215, */                  /* -std=c9x */
  OPT_std_f2003 = 1216,                      /* -std=f2003 */
  OPT_std_f2008 = 1217,                      /* -std=f2008 */
  OPT_std_f2008ts = 1218,                    /* -std=f2008ts */
  OPT_std_f95 = 1219,                        /* -std=f95 */
  OPT_std_gnu = 1220,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1221, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1222, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1223,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1224,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1225,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1226,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1227, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1228, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1229,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1230,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1231, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1232, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1233,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1234, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1235, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1236, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1237,                     /* -std=legacy */
  OPT_symbolic = 1238,                       /* -symbolic */
  OPT_t = 1239,                              /* -t */
  OPT_time = 1240,                           /* -time */
  OPT_time_ = 1241,                          /* -time= */
  OPT_tno_android_cc = 1242,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1243,                 /* -tno-android-ld */
  OPT_traditional = 1244,                    /* -traditional */
  OPT_traditional_cpp = 1245,                /* -traditional-cpp */
  OPT_trigraphs = 1246,                      /* -trigraphs */
  OPT_u = 1247,                              /* -u */
  OPT_undef = 1248,                          /* -undef */
  OPT_v = 1249,                              /* -v */
  OPT_version = 1250,                        /* -version */
  OPT_w = 1251,                              /* -w */
  OPT_wrapper = 1252,                        /* -wrapper */
  OPT_x = 1253,                              /* -x */
  OPT_z = 1254,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
